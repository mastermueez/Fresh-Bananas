...
if(isset($_POST['save'])){
    ...
    $target = "includes/".basename($image);

    $query= "INSERT INTO movies(title, release_date, runtime, image) VALUES('$title', '$release_date','$runtime','$image')";
    //executing query
            ...
            <div class="header__content row">
                ...
                <nav class="header__nav-wrap">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="current"><a href="contact.php" title="">Add Movie</a></li>
                    </ul> <!-- end header__nav -->
            ...
            <div class="col-full s-content__main">
                ...
                <div class="row">
                    ...
                    <div class="col-six tab-full">
                        ...
                        <p>contact@FreshBananas.com<br>
                        info@FreshBananas.com <br>
                        Phone: (+880) 187 354 7400
                        </p>
                ...
                <form name="cForm" id="cForm" method="post" enctype="multipart/form-data" action="">
                    <fieldset>
                        ...
                        <div class="form-field">
                            <input name="title" type="text" id="title" class="full-width" placeholder="Movie Title" value="">
                        </div>

                        <div class="form-field">
                            <input name="release_date" type="date" id="release_date" class="full-width" placeholder="Release Date" value="">
                        </div>

                        <div class="form-field">
                            <input name="runtime" type="number" id="runtime" class="full-width" placeholder="Runtime"  value="">
                        </div> 

                        <div>
                          <label for="image" class="btn">Select Image</label>
                          <input name="image" type="file" id="image" style="visibility:hidden;"/>
                        </div>

                        <!-- <button type="submit" class="submit btn btn--primary full-width">Submit</button> -->
                        <input type="submit" name = "save" value="Submit" class="submit btn btn--primary full-width" />
                    </fieldset>
                </form> <!-- end form -->
            ...
            <div class="row">
                <div class="col-full">
                    <div class="s-footer__copyright">
                        <span>© Copyright Fresh Bananas 2018</span> 
