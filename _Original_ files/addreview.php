...
if(isset($_POST['save'])){
    ...
    $query= "INSERT INTO reviews(title, release_date, runtime, link, image) VALUES('$title', '$release_date','$runtime', '$link', '$image')";
    //executing query
                        ...
                        <ul class="header__nav">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="genre.php">All Genres</a></li>                            
                                </ul>
                            </li>
                            <li class="has-children">
        ...
        <section class="s-content s-content--narrow">
            ...
            <form name="cForm" id="cForm" method="post" enctype="multipart/form-data" action="">
                <fieldset>
                    <div class="row">
                        <div class="col-six tab-full">
                            <div class="form-field">
                                <input name="heading" type="text" id="heading" class="full-width" placeholder="Review Title" value="">
                            </div>
                        </div>
                        <div class="col-six tab-full">
                           <div align = "right">
                  ...
                  <textarea class="full-width" placeholder="Description" id="description"></textarea>
